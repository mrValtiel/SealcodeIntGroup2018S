var kotki = [
  ...
  { imie: "Sebastian", poziom_slodkosci: 12, obraz: { url: "https://vallaura.files.wordpress.com/2015/12/sweet-cat-prayering-image.jpg" , rozmiar: "L"  }},
...
kot0.src = kotki[0].obraz.url;
kot1.src = kotki[1].obraz.url;
kot2.src = kotki[2].obraz.url;
kot3.src = kotki[3].obraz.url;
kot4.src = kotki[4].obraz.url;
kot5.src = kotki[5].obraz.url;
